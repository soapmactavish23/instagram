...
public class AdapterFeed extends RecyclerView.Adapter<AdapterFeed.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        //Recuperar as postagens curtidas
        ...
        curtidasRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                curtida.setUsuario(UsuarioFirebase.getUsuarioLogado());
                ...
                //Adicionar o evento de click no comentario
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            fotoPostagem = itemView.findViewById(R.id.imgPostagem);
            nome         = itemView.findViewById(R.id.txtNomePerfil);
            qtdCurtidas  = itemView.findViewById(R.id.txtCurtidas);
